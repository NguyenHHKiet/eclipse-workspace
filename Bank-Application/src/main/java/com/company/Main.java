...
public class Main {
	...
	public static void PrintBranch() {
		System.out.println(
				"Press 1, to print the branches, press 2 to print a branch with customers and press any other key to print a customer with the transactions");
