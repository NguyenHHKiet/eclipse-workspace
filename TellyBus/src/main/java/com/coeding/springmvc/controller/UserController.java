...
public class UserController {
	...
	public String showLogin(Locale locale) {
		logger.info("Welcome UserController! The client locale is {}.", locale);
		logger.info("Welcome UserController! The client locale is {}.", ApplicationProperty.userName);
		logger.info("Welcome UserController! The client locale is {}.", ApplicationProperty.userEmail);
		return "login";
	}
	...
	public String getReserveBook(@Validated(FormValidationGroup.class) Reserve reserve, Model model, Principal principal) {
		...
		List<Reserve> reserves = reserveService.getReserve(username);
